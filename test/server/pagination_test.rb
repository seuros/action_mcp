...
module ActionMCP
  module Server
    class PaginationTest < ActiveSupport::TestCase
      ...
      test "tasks_result poll interval requires a positive value" do
        assert_raises(ArgumentError) do
          ActionMCP.configuration.tasks_result_poll_interval = 0
        end
        ...
        ActionMCP.configuration.tasks_result_poll_interval = 0.5
        assert_equal 0.5, ActionMCP.configuration.tasks_result_poll_interval
      ensure
        ActionMCP.configuration.tasks_result_poll_interval = 0.25
      end
    end
  end
end
